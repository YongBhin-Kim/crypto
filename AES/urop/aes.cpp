...
void AES32_Dec_KeySchedule(byte k[16], u32 rk[11][4]) {
	...
	for (int i = 1; i < 10; i++) {
		...
		rk[i][0] = Td0[Te4[(rk[i][0] >> 24) &0xff ] & 0xff] 
            ^ Td1[Te4[(rk[i][0] >> 16) & 0xff] & 0xff]
			^ Td2[Te4[(rk[i][0] >> 8) & 0xff] & 0xff] 
            ^ Td3[Te4[(rk[i][0]) & 0xff] & 0xff];
		rk[i][1] = Td0[Te4[(rk[i][1] >> 24) &0xff ] & 0xff] 
            ^ Td1[Te4[(rk[i][1] >> 16) & 0xff] & 0xff]
			^ Td2[Te4[(rk[i][1] >> 8) & 0xff] & 0xff] 
            ^ Td3[Te4[(rk[i][1]) & 0xff] & 0xff];
		rk[i][2] = Td0[Te4[(rk[i][2] >> 24) &0xff ] & 0xff] 
            ^ Td1[Te4[(rk[i][2] >> 16) & 0xff] & 0xff]
			^ Td2[Te4[(rk[i][2] >> 8) & 0xff] & 0xff] 
            ^ Td3[Te4[(rk[i][2]) & 0xff] & 0xff];
		rk[i][3] = Td0[Te4[(rk[i][3] >> 24) &0xff ] & 0xff] 
            ^ Td1[Te4[(rk[i][3] >> 16) & 0xff] & 0xff]
			^ Td2[Te4[(rk[i][3] >> 8) & 0xff] & 0xff] 
