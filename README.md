...
**[AES]** <br>
AES의 SBox 연산은 유한체인 Rijndael Field (GF(2^8)) 에서 다루어지므로 기존의 연산과 다른 Quotient Field : GF(2)[x]/<m(x)> 위에서의 연산으로 이루어진다. <br>
...
AES의 MixColumns 연산은 Quotient Ring : GF(2^8)[x]/<x^4 + 1> 위에서의 연산으로 이루어진다. <br>
