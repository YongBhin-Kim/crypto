...
/*********************** SHA224 Function Definitions ***********************/
void _sha256_transform( SHA224_CTX *ctx, const u8 data[] ) {
...
void sha224_final( OUT SHA224_CTX *ctx, OUT u8 digest[] ) {
    ...
    // SHA224 digest gets leftmost bits of SHA256 digest
	for (i=0; i<4; ++i) {
