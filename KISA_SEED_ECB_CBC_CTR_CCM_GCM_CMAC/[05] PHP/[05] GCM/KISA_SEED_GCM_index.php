<?php
require_once ('KISA_SEED_GCM.php');
...
function encrypt(&$pet, $pinput, $macLen, $pnonce, $paad, $pkey)
{
    ...
    $result = KISA_SEED_GCM::SEED_GCM_Encryption($output, $input, $inputLen, $macLen, $nonce, $nonceLen, $aad, $aadLen, $key);
...
function decrypt(&$pdt, $pinput, $macLen, $pnonce, $paad, $pkey)
{
    ...
    $result = KISA_SEED_GCM::SEED_GCM_Decryption($output, $input, $inputLen, $macLen, $nonce, $nonceLen, $aad, $aadLen, $key);
...
<title>국산암호 [SEED - GCM] 테스트 페이지</title>
</head>
<body>
<center>
<h1>국산 암호 [SEED-GCM] 테스트 페이지</h1>
<form name="myform1" method="post" action="./KISA_SEED_GCM_index.php">
<input type="hidden" name="method" id="method" />
<table border="0">
<tr>
<td style="text-align:center;">
<form method="post" action="./KISA_SEED_GCM_index.php">
<table border="0">
...
<td style="text-align:center;">
<form name="myform2" method="post" action="./KISA_SEED_GCM_index.php">
<table border="0">
...
<tr>
<td>&lt;암호문&gt; : </td>
<td>7F,93,7D,FA,22,B2,4C,06,69,50,D6,1D,11,ED,A9,08,D8,2C,A5,C4,13,81,61,E6,BD,34,24,5F,81,67,33,F4</td>
</tr>
</table>
</div>
</form>
