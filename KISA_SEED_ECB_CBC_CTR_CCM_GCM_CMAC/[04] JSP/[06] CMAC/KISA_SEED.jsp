...
public static void SEED_KeySched(byte[] mKey, int[] rKey)
{
    int ABCD[] = new int[4];
    int T[] = new int[2];
...
public static void SEED_Encrypt(int[] pOut, int[] pIn, int[] rKey)
{
    int LR[] = new int[4];
    int T[] = new int[2];
...
public static void SEED_Decrypt(int[] pOut, int[] pIn, int[] rKey)
{
    int LR[] = new int[4];
    int T[] = new int[2];
