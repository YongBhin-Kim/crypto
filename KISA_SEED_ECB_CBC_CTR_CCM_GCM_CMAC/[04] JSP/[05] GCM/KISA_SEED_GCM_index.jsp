<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ include file="KISA_SEED_GCM.jsp" %>
<%!
...
if ((method != null) && (method.equals("e")))
{
	...
	if (keyStr != null)
	{
        ...
        ret = SEED_GCM_Encryption(output, input, inputLen, macLen, nonce, nonce.length, aad, aadLen, key);
...
else if ((method != null) && (method.equals("d")))
{
	...
	if (keyStr != null)
	{
        ...
        ret = SEED_GCM_Decryption(output, input, inputLen, macLen, nonce, nonce.length, aad, aadLen, key);
...
<form name="myform" method="post" action="KISA_SEED_GCM_index.jsp">
...
<tr>
<td>&lt;암호문&gt; : </td>
<td><% out.print("7F,93,7D,FA,22,B2,4C,06,69,50,D6,1D,11,ED,A9,08,D8,2C,A5,C4,13,81,61,E6,BD,34,24,5F,81,67,33,F4"); %></td>
</tr>
</table>
</div>
</form>
