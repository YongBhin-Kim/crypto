...
public static int SEED_GCM_Encryption(
    byte[] ct,
    byte[] pt, int ptLen,
    int macLen,
...
public static int SEED_GCM_Decryption(
    byte[] pt,
    byte[] ct, int ctLen,
    int macLen,
    byte[] nonce, int nonceLen,
