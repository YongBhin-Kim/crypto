<!--#include file="KISA_SEED_GCM.asp" -->
<%
...
function encrypt(byref output, input, macLen, nonce, aad, key)
	...
	result = KISA_SEED_GCM.SEED_GCM_Encryption(data, input, ubound(input) + 1, macLen, nonce, ubound(nonce) + 1, aad, ubound(aad) + 1, key)
...
function decrypt(byref output, input, macLen, nonce, aad, key)
	...
	result = KISA_SEED_GCM.SEED_GCM_Decryption(data, input, ubound(input) + 1, macLen, nonce, ubound(nonce)+1, aad, ubound(aad)+1, key)
...
<form name="myform" method="post" action="./KISA_SEED_GCM_index.asp">
<input type="hidden" name="method" id="method" />
<table border="0">
<tr>
<td style="text-align:center;">
<form method="post" action="./KISA_SEED_GCM_index.asp">
<table border="0">
